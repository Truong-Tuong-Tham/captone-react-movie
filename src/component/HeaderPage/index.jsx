...
const HeaderPage = () => {
  ...
  return (
    <header className="bg-gray-900 h-24 sm:h-32 md:h-40 lg:h-48 xl:h-56 flex items-center">
      <div className="w-full max-w-screen-xl mx-auto flex items-center justify-between px-4 sm:px-6 md:px-8">
        <div className="flex items-center space-x-4 sm:space-x-6 md:space-x-8 flex-grow">
          <img
            className="w-20 sm:w-24 md:w-32 lg:w-40 xl:w-48 h-auto rounded-full shadow-lg"
            src="https://cdn-icons-png.flaticon.com/512/3271/3271747.png" // Movie camera icon
            alt="Movie Camera Icon"
          />
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-white font-bold flex-grow text-left">
            CINEMA ESCAPADE
          </p>
        </div>
        {renderNavUserLogin()}
